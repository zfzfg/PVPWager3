...
public class WagerGUI {
    ...
    private void setupControlButtons(Inventory inventory, Match match, Player viewer) {
        ...
        if (skipMeta != null) {
            ...
            if (hasVoted) {
                ...
                skipMeta.setLore(Arrays.asList(
                    MessageUtil.color("&7Du hast fuer Skip gestimmt"),
                ...
                skipMeta.setLore(Arrays.asList(
                    MessageUtil.color("&7Dein Gegner moechte ohne"),
                    MessageUtil.color("&7Wetteinsatz kaempfen!"),
                    MessageUtil.color(""),
                ...
                skipMeta.setDisplayName(MessageUtil.color("&e&lSKIP WAGER"));
                skipMeta.setLore(Arrays.asList(
                    MessageUtil.color("&7Kaempfe ohne Wetteinsatz!"),
                    MessageUtil.color(""),
                    MessageUtil.color("&7Beide Spieler muessen"),
        ...
        if (confirmMeta != null) {
            ...
            confirmMeta.setLore(Arrays.asList(
                ...
                MessageUtil.color("&7zu bestaetigen")
            ));
    ...
    private void setupMoneyControls(Inventory inventory, Match match, Player viewer) {
        ...
        if (moneyMeta != null) {
            moneyMeta.setDisplayName(MessageUtil.color("&6&lGELD EINSATZ"));
    ...
    private void createMoneyButton(Inventory inventory, int slot, int amount, String displayName) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Arrays.asList(
                ...
                MessageUtil.color("&7hinzuzufuegen/abzuziehen")
            ));
