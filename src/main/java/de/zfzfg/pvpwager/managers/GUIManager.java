...
public class GUIManager {
    ...
    // Getter methods for direct GUI access
    public WagerGUI getWagerGUI() {
        return wagerGUI;
    }
    
    public ArenaSelectionGUI getArenaSelectionGUI() {
        return arenaSelectionGUI;
    }
    
    public EquipmentSelectionGUI getEquipmentSelectionGUI() {
        return equipmentSelectionGUI;
    }
